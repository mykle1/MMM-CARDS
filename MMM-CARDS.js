...
Module.register("MMM-CARDS", {
    ...
    defaults: {
        ...
        header: "Cards",    // Any text you want. useHeader must be true
        maxWidth: "100%",
	...
	if (this.config.useHeader != false) {
        ...
        mmCards.innerHTML = "My cards are . . ."; // the fifth object is cards[4]
		...
		setTimeout(function() {
            img2.src = cards[2].image; // the second object is cards[1]
        }, 3 * 1000);
		...
		setTimeout(function() {
            img3.src = cards[4].image; // the third object is cards[2]
        }, 5 * 1000);
		...
		setTimeout(function() {
            img4.src = cards[6].image; // the fourth object is cards[3]
        }, 7 * 1000);
		...
		setTimeout(function() {
            img5.src = cards[8].image; // the fifth object is cards[4]
        }, 9 * 1000);
        ...
        mmCards.classList.add("xsmall", "bright", "spacer");
	    setTimeout(function() {
            mmCards.innerHTML = "Magic Mirror's Cards"; // the fifth object is cards[4]
        }, 11 * 1000);
		mirrorCards.appendChild(mmCards);
		wrapper.appendChild(mirrorCards);
        ...
        setTimeout(function() {
            img6.src = cards[1].image; // the fifth object is cards[4]
        }, 13 * 1000);
		...
		setTimeout(function() {
            img7.src = cards[3].image; // the second object is cards[1]
        }, 15 * 1000);
		...
		setTimeout(function() {
            img8.src = cards[5].image; // the third object is cards[2]
        }, 17 * 1000);
		...
		setTimeout(function() {
            img9.src = cards[7].image; // the fourth object is cards[3]
        }, 19 * 1000);
		...
		setTimeout(function() {
            img10.src = cards[9].image; // the fifth object is cards[4]
        }, 21 * 1000);
